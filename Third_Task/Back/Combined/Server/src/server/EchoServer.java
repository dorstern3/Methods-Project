			...
			if (msg instanceof Message) {
				...
				case TRAVELER_LOGIN: {
					...
					if(travelerId.length() == 4) {
						String subscriberId = db.DBselect.getTravelerIdBySubNumber(travelerId);
				...
				case TRAVELER_LOGOUT: {
					...
					if(travelerIdentifier.length() == 4) {
						String subscriberId = db.DBselect.getTravelerIdBySubNumber(travelerIdentifier);
						if(subscriberId == null) {
							client.sendToClient(new Message(MessageType.TRAVELER_LOGOUT , null));
							break;
						}

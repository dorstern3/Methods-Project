...
-- (ID changed to exactly 5 digits! Sub number stays 4 digits)
-- ------------------------------------------------------
...
-- ------------------------------------------------------
-- 3. Populating Guides 
-- (Guide IDs are already exactly 5 digits)
-- ------------------------------------------------------
...
-- (All IDs connected to these orders changed to 5 digits)
-- ------------------------------------------------------
INSERT INTO `order` 
...
(3520, '2026-06-21', 1, 'QR-3520', 55555, '2026-06-15', '10:00:00', NULL, 'Booked', 'Regular', 'Banias', 'regular_visitor@gmail.com', '050-8888881'),

-- Order 3521: Tomorrow's order (Pending confirmation for email alert simulation)
(3521, '2026-06-18', 4, 'QR-3521', 11111, '2026-06-14', '12:30:00', NULL, 'Pending confirmation', 'Subscriber', 'Caesarea', 'yossi.cohen@gmail.com', '050-1234567'),

-- Order 3522: Confirmed order ready for park gate entry
(3522, '2026-06-25', 1, 'QR-3522', 22222, '2026-06-12', '14:00:00', NULL, 'Confirmed', 'Subscriber', 'Ein Gedi', 'dana.levi@gmail.com', '052-7654321'),
...
(3524, '2026-06-16', 1, 'QR-3524', 77777, '2026-06-11', '11:00:00', NULL, 'Canceled', 'Regular', 'Banias', 'canceled_user@gmail.com', '054-9999999'),

-- Order 3525: Waiting list test target at Achziv (Capacity = 10 baseline trigger)
(3525, '2026-06-20', 3, 'QR-3525', 33333, '2026-06-16', '10:00:00', NULL, 'On waiting list', 'Subscriber', 'Achziv', 'ron.shani@gmail.com', '054-1112223');

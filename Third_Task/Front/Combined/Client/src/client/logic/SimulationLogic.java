...
public class SimulationLogic {
	 ...
	 * request to the server to simulate the daily reminder check. * @return An
	 * ArrayList of Order objects that need reminders, or an empty list if none
	 * exist.
	 */
	 ...
	 * next travelers in line. * @return An ArrayList of String notifications
	 * describing the processed waitlist timeouts, or an empty list if there are no
	 * updates.
	 */
	@SuppressWarnings("unchecked")
	public ArrayList<String> simulateWaitlistTimeout() {
		Message response = (Message) ClientUI.clientChat
				.accept(new Message(MessageType.SIMULATE_WAITLIST_TIMEOUT, null));
	 ...
	 * availability. * @return An ArrayList of String notifications describing the
	 * processed confirmation timeouts, or an empty list if there are no updates.
	 */
	@SuppressWarnings("unchecked")
	public ArrayList<String> simulateConfirmationTimeout() {
		Message response = (Message) ClientUI.clientChat
				.accept(new Message(MessageType.SIMULATE_CONFIRMATION_TIMEOUT, null));
		return (response != null) ? (ArrayList<String>) response.getData() : new ArrayList<>();
	}
}
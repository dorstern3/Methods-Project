...
public class ManageOrderController {
	...
	void clickSearchOrder(ActionEvent event) {
		...
		if (reply != null && reply.getMessageType() == MessageType.FETCH_ORDER_RESULT) {
			currentOrder = (ArrayList<Object>) reply.getMessageData();
	...
	void clickConfirmOrder(ActionEvent event) {
		...
		if (reply != null && reply.getMessageType() == MessageType.UPDATE_ORDER_RESULT) {
			ArrayList<Object> result = (ArrayList<Object>) reply.getMessageData();

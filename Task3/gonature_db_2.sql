...
--
-- Host: 127.0.0.1    Database: gonature_db_new
-- ------------------------------------------------------
...
INSERT INTO `guide` VALUES (1000,'Avi','Ronen','avi.guide@gmail.com','050-1111111'),(1001,'Gal','Tal','gal.guide@gmail.com','052-2222222'),(1002,'Tom','Nir','tom.guide@gmail.com','054-3333333'),(1003,'Adi','Bar','adi.guide@gmail.com','053-4444444'),(1004,'Omer','Golan','omer.guide@gmail.com','058-5555555'),(1005,'ddd','sss','@@@','3333');
...
CREATE TABLE `parameter_requests` (
  ...
  KEY `fk_req_to_park` (`park_name`),
  KEY `fk_req_to_worker` (`worker_id`),
...
INSERT INTO `parameter_requests` VALUES (1,'Banias',1,'max_capacity',500,600,'Approved','2026-06-05 14:28:19'),(2,'Banias',1,'max_capacity',500,600,'Approved','2026-06-05 14:30:45'),(3,'Banias',1,'max_capacity',500,600,'Rejected','2026-06-05 14:38:25'),(4,'Banias',1,'max_capacity',500,9,'Rejected','2026-06-05 14:38:58'),(5,'Banias',1,'estimated_stay_time',500,99,'Rejected','2026-06-05 14:39:07'),(6,'Banias',1,'max_capacity',500,600,'Approved','2026-06-05 14:47:56'),(7,'Banias',1,'max_capacity',500,8,'Approved','2026-06-05 14:48:09'),(8,'Banias',1,'estimated_stay_time',500,7,'Approved','2026-06-05 14:48:23'),(9,'Banias',1,'max_capacity',500,600,'Approved','2026-06-05 15:03:58'),(10,'Banias',1,'max_capacity',500,600,'Rejected','2026-06-05 15:08:58'),(11,'Banias',1,'max_capacity',500,600,'Approved','2026-06-05 15:25:57'),(12,'Banias',1,'max_capacity',500,99,'Rejected','2026-06-05 15:37:42');
...
CREATE TABLE `parks` (
  ...
  `estimated_stay_time` int NOT NULL DEFAULT '4',
...
INSERT INTO `parks` VALUES ('Achziv',400,40,50,35,0,4),('Banias',600,50,120,39,1,7),('Caesarea',1000,100,450,45,0.1,4),('Ein Gedi',600,60,200,28,0.15,4),('Masada',800,80,300,50,0,4);
...
-- Dump completed on 2026-06-05 18:48:50

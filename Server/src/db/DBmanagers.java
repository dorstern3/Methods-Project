...
public class DBmanagers {
	public static void handleSubmitParameterRequest(Message message, ConnectionToClient client) {
		...
		String query = "INSERT INTO gonature_db_new.parameter_requests (park_name, worker_id, parameter_name, current_value, request_value, status, request_date) VALUES (?, ?, ?, ?, ?, 'Pending', CURDATE())";
